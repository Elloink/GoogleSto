...
public class BaseActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// IntentFilter("com.googles.threelu.killall");
		// registerReceiver(receiver, filter);

		// 3最后只需要在其子类activity中添加 如下代码即可关闭当前的activity，sendBroadcast(new
		// Intent("com.googles.threelu.killall"));
	...
	/**
	 * 第一种杀死activity的方法 移除所有的activity
	 */
	public void killAll() {
		// 复制了一份mActivity
